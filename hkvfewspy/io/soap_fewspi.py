...
from ..schemas.timeseries import FewsTimeSeriesCollection
...
class PiSoap(object):
    ...
    def getTaskRunStatus(self, taskId, maxWaitMillis=1000):
        ...
        try:
            ...
            getTaskRunStatus_response = self.client.service.getTaskRunStatus(
                in0=taskId, in1=maxWaitMillis
            )
        except TypeError:
            # for tomcat FewsPi services
            getTaskRunStatus_response = self.client.service.getTaskRunStatus(
                taskId=taskId, maxWaitMillis=maxWaitMillis
            )
    ...
    def getParameters(self, filterId="", piVersion="1.22", clientId=None):
        ...
        try:
            ...
            getParameters_response = self.client.service.getParameters(
                in0=clientId, in1=filterId, in2=piVersion
            )
        except TypeError:
            # for tomcat FewsPi services
            getParameters_response = self.client.service.getParameters(
                clientId=clientId, filterId=filterId, piVersion=piVersion
            )
    ...
    def getWorkflows(self, piVersion="1.22", clientId=None):
        ...
        try:
            # for embedded FewsPi services
            getWorkflows_response = self.client.service.getWorkflows(in0=piVersion)
        except TypeError:
            # for tomcat FewsPi services
    ...
    def getLocations(
        self, filterId="", piVersion="1.22", clientId=None, setFormat="df"
    ):
        """
    ...
    def getTimeSeries(
        self, queryParameters, header="longform", setFormat="df", print_response=False
    ):
        """
        ...
        df_timeseries = read_timeseries_response(
            ...
            tz_client=queryParameters["clientTimeZone"],
            header=header,
        )
