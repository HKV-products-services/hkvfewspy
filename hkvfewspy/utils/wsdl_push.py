def push(prefill_defaults):
    """
    Create a new push object.
    Returns a new :class:`DataPush` instance appropriate for this endpoint.
    
    Returns
    -------
    valid : bool
        Whether `push` is valid.
    """
...
class DataPush(object):
    """
    Represent a push object for data to go to a Delft-FEWS pi client.
    This object provides a clear API to formulate a Pi timeseries data. For a putTimeSeries method.
